...
void vexcodeInit(void) {
  mainDrive.addModule(new bancroft::Module(new vex::motor_group(*(new vex::motor(PORT3, vex::gearSetting::ratio18_1, true)), *(new vex::motor(PORT4, vex::gearSetting::ratio18_1, false)), *(new vex::motor(PORT6, vex::gearSetting::ratio18_1, true))), "Intake"));
